          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div className="space-y-0.5">
                ...
                <h1 className="text-2xl font-black text-slate-900 tracking-tight">Create Educational Module</h1>
              </div>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid gap-8">
                <div className="space-y-3">
                  ...
                  <Input
                    ...
                    className="h-11 rounded-xl border-gray-100 bg-gray-50/50 focus:bg-white focus:ring-4 focus:ring-saBlue/5 transition-all px-4 text-sm font-medium"
                    required
                  />
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <Textarea
                    ...
                    rows={4}
                    className="rounded-xl border-gray-100 bg-gray-50/50 focus:bg-white focus:ring-4 focus:ring-saBlue/5 transition-all p-4 text-sm font-medium resize-none"
                    required
                  />
                </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        placeholder="0"
                        className="h-11 rounded-xl border-gray-100 bg-gray-50/50 focus:bg-white focus:ring-4 focus:ring-saBlue/5 transition-all pl-12 pr-4 text-sm font-medium"
                      />
                    </div>
                  </div>

                  <div className="bg-saBlue/5 rounded-xl p-4 border border-saBlue/10 flex items-center gap-3 group">
                    <div className="p-2.5 bg-white rounded-lg text-saBlue shadow-sm group-hover:scale-110 transition-transform">
                      <Sparkles className="w-4 h-4" />
                    </div>
                    <div>
                      <p className="text-[9px] font-black text-saBlue uppercase tracking-widest mb-0.5">Quick Tip</p>
          ...
          <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-4 pt-4">
            <Button
              ...
              className="flex-1 sm:flex-none sm:min-w-[160px] h-11 rounded-xl border-gray-200 font-bold text-[10px] uppercase tracking-[0.2em] hover:bg-gray-50 transition-all"
            >
              Discard Changes
            </Button>
            <Button
              type="submit"
              disabled={loading}
              className="flex-1 sm:flex-none sm:min-w-[160px] h-11 bg-saBlue hover:bg-saBlue/90 text-white rounded-xl font-bold text-[10px] uppercase tracking-[0.2em] shadow-xl shadow-saBlue/20 transition-all active:scale-95"
            >
              {loading ? (
                <>
